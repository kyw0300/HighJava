...
/*
	...
	- String클래스, Wrapper클래스들, Data클래스, File클래스에는 내부 정렬 기준이 구현되어 있다.
...
public class ListSortTest {
	public static void main(String[] args) {
		...
		// List의 정렬은 Collections.sort() 메서드를 이용해서 정렬한다.
...
// 정렬 방식을 정해주는 class를 작성 (이것을 외부 정렬 기준 클래스라고 한다.)
...
class Desc implements Comparator<String> {
	...
	// 예) 오름차순일 경우 ==> 앞의 값이 크면 양수, 같으면 0, 작으면 음수를 반환하도록 구현
	@Override
