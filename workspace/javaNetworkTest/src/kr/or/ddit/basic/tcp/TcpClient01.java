...
// 서버에 접속을 시도하고 접속이 완료되어 서버에서 보낸 환영 메시지를 받아서 화면에 출력한다.
public class TcpClient01 {
	public static void main(String[] args) throws UnknownHostException, IOException {
		/*
			통신에서 현재의 컴퓨터를 나타내는 방법
		1. 원래의 IP주소 : 예) 192.168.146.52
		2. 지정된 IP주소 : 127.0.0.1 (자기 자신 컴퓨터를 의미)
		3. 원래의 컴퓨터 이름 : 예) DESKTOP - 21412223
...
//		Socket socket = new Socket("상대방의 IP주소", "상대방의 Port번호");
		...
		// 이 부분부터는 서버와 연결이 완료된 상태이어야만 실행되는 코드다.
