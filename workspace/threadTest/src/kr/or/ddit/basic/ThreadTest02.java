...
public class ThreadTest02 {
	public static void main(String[] args) {
		...
		// 방법1
		// Thread 클래스를 상속한 class를 작성한 후 class의 인스턴스를 생성한 후 
		...
		// 이 때 생성된 Thread 객체의 start() 메소드를 호출해서 실행
...
// 방법2-1 ==> Runnable 인터페이스를 구현한 class 작성하기
class MyRunner1 implements Runnable {
	
	@Override
	public void run() { // 쓰레드가 처리할 내용을 이 run() 메서드에 기술한다.
		for(int i=1; i<=200; i++) {
			System.out.print("&");
			try {
				Thread.sleep(10);
